# wheres_Imma_v011.aleo

## High level overview of Where's Imma with the Puzzle Wallet and Puzzle SDK
...
# Walking through the Where's Imma Leo programs

<br />

Note: There is additional technical functionality in the wheres_Imma program for better FE UX and notification enablement that is not explained in detail below.
